...
_sage_const_0x5DEECE66D = Integer(0x5DEECE66D); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_48 = Integer(48); _sage_const_100 = Integer(100); _sage_const_4 = Integer(4); _sage_const_32 = Integer(32)# https://crypto.stackexchange.com/questions/37836/problem-with-lll-reduction-on-truncated-lcg-schemes
